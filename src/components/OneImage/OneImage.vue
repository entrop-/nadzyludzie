...
export default {
  ...
  setup(props) {
    ...
    const con0 = ['Fake', 'Innocent', 'White', 'Black', 'Latino', 'Big titty', 'My', 'Beautiful', 'Amazing',
    ...
    const con4 = ['in fake taxi', 'on prom night', 'with midgets', 'in public', 'in the shower', 'next to sleeping sister', 'in dad`s car',
      'and one cup', 'on the internet', 'for money', 'on valentine`s day', 'in church', 'in oil', 'in the pool', 'at the party',
        'in missionary position', 'for the glory of satan', 'during orgy', 'for job interview', ', almost caught', 'stuck in washing machine',
